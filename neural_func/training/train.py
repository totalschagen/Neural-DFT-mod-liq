...
## fix deterministic seed for training
...
## Prepare data paths
scratch_path = "/scratch/c7051233/Neural_functional_project"
training_data_path = os.path.join(scratch_path,"datasets/training_sets")
dataname = os.path.join(training_data_path, "check_train.pt")
output_path= os.path.join(scratch_path,"neural_func/training_metrics")
