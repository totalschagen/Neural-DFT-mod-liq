...
class conv_neural_func5(nn.Module):
    def __init__(self,window_size,k):
        ...
        self.conv4 = nn.Conv2d(k,k,kernel_size = 1)
        self.conv5 = nn.Conv2d(k,1,kernel_size = 1)
...
class conv_neural_func7(nn.Module):
    def __init__(self,window_size,k):
        ...
        self.conv3 = nn.Conv2d(k,k,kernel_size = 1)
        self.conv4 = nn.Conv2d(k,k,kernel_size = 1)
        self.conv5 = nn.Conv2d(k,k,kernel_size = 1)
        self.conv6 = nn.Conv2d(k,k,kernel_size = 1)
        self.conv7 = nn.Conv2d(k,1,kernel_size = 1)
...
class conv_neural_func9(nn.Module):
    def __init__(self,window_size):
        super(conv_neural_func9, self).__init__()
        self.conv1 = nn.Conv2d(1,24,kernel_size = window_size)
        self.conv2 = nn.Conv2d(24,24,kernel_size = 1)
        self.conv3 = nn.Conv2d(24,24,kernel_size = 1)
        self.conv4 = nn.Conv2d(24,24,kernel_size = 1)
        self.conv5 = nn.Conv2d(24,24,kernel_size = 1)
        self.conv6 = nn.Conv2d(24,24,kernel_size = 1)
        self.conv7 = nn.Conv2d(24,1,kernel_size = 1)
